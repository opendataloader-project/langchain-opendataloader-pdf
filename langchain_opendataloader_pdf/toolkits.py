...
class OpenDataLoaderPDFToolkit(BaseToolkit):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from opendataloader-pdf-langchain import OpenDataLoaderPDFToolkit

            toolkit = OpenDataLoaderPDFToolkit(
                # ...
            )
