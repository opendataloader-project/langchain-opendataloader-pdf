...
class OpenDataLoaderPDFRetriever(BaseRetriever):
    ...
    """OpenDataLoaderPDF retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``opendataloader-pdf-langchain`` and set environment variable
        ``OPENDATALOADERPDF_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from opendataloader-pdf-langchain import OpenDataLoaderPDFRetriever

            retriever = OpenDataLoaderPDFRetriever(
                # ...
            )
